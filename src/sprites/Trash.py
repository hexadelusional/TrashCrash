...
trash_list = [
	{"name" : "Apple_core", "bin" : "red", "img" : pygame.transform.scale(pygame.image.load('assets/images/Trash_PNG/Apple_core.png'),(60,40))}, 
	{"name" : "Banana", "bin" : "red", "img" : pygame.transform.scale(pygame.image.load('assets/images/Trash_PNG/Banana.png'),(45,18)) },
	{"name" : "Box", "bin" : "yellow", "img" : pygame.transform.scale(pygame.image.load('assets/images/Trash_PNG/Box.png'),(49,46)) },
	{"name" : "Bread", "bin" : "red", "img" : pygame.transform.scale(pygame.image.load('assets/images/Trash_PNG/Bulb.png'),(25,44)) },
	{"name" : "Bulb", "bin" : "blue", "img" : pygame.transform.scale(pygame.image.load('assets/images/Trash_PNG/Can.png'),(42,77)) },
	{"name" : "Can", "bin" : "yellow", "img" : pygame.transform.scale(pygame.image.load('assets/images/Trash_PNG/Cig_Butt.png'),(32,10)) },
	{"name" : "Cig_Butt", "bin" : "blue", "img" : pygame.transform.scale(pygame.image.load('assets/images/Trash_PNG/Glass.png'),(46,68) )},
	{"name" : "Glass_Bottle", "bin" : "yellow", "img" : pygame.transform.scale(pygame.image.load('assets/images/Trash_PNG/Glass_bottle.png'),(15,48)) },
	{"name" : "Glass", "bin" : "yellow", "img" : pygame.transform.scale(pygame.image.load('assets/images/Trash_PNG/Gum.png'),(23,14) )},
	...
	{"name" : "Lighter", "bin" : "blue", "img" : pygame.transform.scale(pygame.image.load('assets/images/Trash_PNG/Lighter.png'),(8,27) )},
	{"name" : "Mask", "bin" : "blue", "img" : pygame.transform.scale(pygame.image.load('assets/images/Trash_PNG/Mask.png'),(50,34) )},
	{"name" : "Mercury_battery", "bin" : "blue", "img" : pygame.transform.scale(pygame.image.load('assets/images/Trash_PNG/Mercury_battery.png'),(30,15)) },
	...
	{"name" : "Perfume", "bin" : "yellow", "img" : pygame.transform.scale(pygame.image.load('assets/images/Trash_PNG/Perfume.png'),(24,26) )},
	...
	{"name" : "Raspberry", "bin" : "red", "img" : pygame.transform.scale(pygame.image.load('assets/images/Trash_PNG/Apple_core.png'),(22,24)) },
